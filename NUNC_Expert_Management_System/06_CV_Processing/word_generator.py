#!/usr/bin/env python3
"""
NUNC Expert Management System - Word Document Generator
...
class NuncWordGenerator:
    def __init__(self):
        self.template_path = "08_Output_Files/word_documents/nunc_template.docx"
        self.output_path = "08_Output_Files/word_documents"
    ...
    def generate_word_document(self, template_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            # Fallback: Einfaches Word-Dokument erstellen
            return self._create_simple_word_document(template_data)
    
    def _create_simple_word_document(self, template_data: Dict[str, Any]) -> str:
        """Erstellt ein einfaches Word-Dokument ohne Template"""
        try:
            from docx import Document
            ...
            # Header
            doc.add_heading(f'NUNC Co.-Expert: {template_data.get("expert_name", "Unknown")}', level=1)
            doc.add_paragraph(f'Hauptfokus: {template_data.get("hauptfokus", "Consultant")}')
            ...
            print(f"Einfaches Word-Dokument erstellt: {output_file}")
            return output_file
            
        except Exception as e:
            print(f"Fehler beim Erstellen des einfachen Word-Dokuments: {e}")
            return None
