#!/usr/bin/env python3
"""
NUNC CV Converter - Supabase Integration
...
class SupabaseIntegration:
    def __init__(self, supabase_url: str = None, supabase_key: str = None, openai_api_key: str = None):
        ...
        if self.supabase_url and self.supabase_key:
            ...
            self.supabase = None
            print("⚠️ Supabase nicht konfiguriert - verwende lokale Datenbank")
        ...
        if self.openai_api_key:
            ...
            print("⚠️ OpenAI nicht konfiguriert - verwende lokale Embeddings")
        ...
        try:
            ...
            print("⚠️ Embedding-Model nicht verfügbar")
    ...
    def _save_locally(self, profile_data: Dict[str, Any]) -> str:
        ...
        local_db = "../07_Output_Files/generated_profiles/supabase_local.json"
        os.makedirs("../07_Output_Files/generated_profiles", exist_ok=True)
